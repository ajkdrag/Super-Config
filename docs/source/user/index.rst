...
The simplest way to install Super-Config is using Pip.

.. code-block:: console

    $ pip install superconfig

This will install ``superconfig`` and all of its dependencies.
...
Report bugs at the `issue tracker <https://github.com/GithubUserName/superconfig/issues>`_.
